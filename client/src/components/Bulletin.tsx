...
          /* Masquer tout le contenu de la page par défaut sauf le bulletin */
          body > * {
            display: none !important;
          }

          /* Afficher la racine de l'application (peut être #root ou #__next) */
          #root, #__next { 
...
          
          /* Rétablir l'affichage et retirer min-height du conteneur principal */
          .min-h-screen, .shadow-2xl {
            margin: 0 !important;
            padding: 0 !important;
            background: white !important;
            height: auto !important;
            min-height: 0 !important; /* CRITIQUE : retire la hauteur forcée */
            display: block !important;
            box-shadow: none !important;
            border: none !important;
          }

          /* Le bulletin doit être affiché et dimensionné A4 */
          #bulletin-content {
            display: flex !important; /* Important pour que flex-col fonctionne */
            margin: 0 !important;
...
            box-shadow: none !important;
            border: none !important;
            position: relative !important; /* Éviter les problèmes de positionnement */
            top: auto !important;
            left: auto !important;
            background: white;
            overflow: visible;
...
          /* S'assurer que les couleurs de fond et d'éléments sont conservées */
          * {
            -webkit-print-color-adjust: exact !important;
            print-color-adjust: exact !important;
          }
          
          /* Empêcher les coupures à l'intérieur des éléments clés */
          section, table, .grid {
            page-break-inside: avoid;
          }
        }

        /* Web view styles (Inchangé) */
        @media screen {
          #bulletin-content {
