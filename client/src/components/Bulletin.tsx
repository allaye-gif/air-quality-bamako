...
        @page {
          size: A4;
          margin: 0; /* On enlève les marges du navigateur */
        }

        @media print {

          /* Corps du document parfaitement ajusté */
          html, body {
            width: 210mm;
            height: 297mm;
            margin: 0 !important;
...
          /* Empêche strictement Chrome d’ajouter une seconde page */
          #bulletin-content {
            break-after: avoid;
            break-before: avoid;
            break-inside: avoid;
...
            /* Garde les propriétés de style du bulletin pour l'impression */
            margin: 0 !important;
            padding: 10mm !important;
            width: 210mm !important;
            height: 277mm !important; /* 297mm minus padding */
...
          /* Empêche les boîtes internes d'être coupées */
          section, div, table, .card, .panel {
            break-inside: avoid;
            page-break-inside: avoid;
          }

          /* Optionnel : supprimer les ombres (qui provoquent des dépassements) */
          * {
            box-shadow: none !important;
            -webkit-print-color-adjust: exact !important;
            print-color-adjust: exact !important;
